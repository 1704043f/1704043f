        ...
        return (
            ...
            <CardBody className="actionTableBody TableBody">
                <CardTitle className="actionTableTitle Title">Actions</CardTitle>
                    ...
                    <div className="actTableSelMed" style={{fontWeight: this.props.selectMedicationCard || this.props.editMedicationCard || this.props.removeMedicationConfirmCard ? "bold" : ""}}><a onClick={() => this.onClicked("select medication")}>Select medication</a></div>
                    
                    <div className="actTableAddNewMed" style={{fontWeight: this.props.addMedicationCard || this.props.confirmAddMedicationCard ? "bold" : ""}}><a onClick={() => this.onClicked("add medication")}>Add new medication</a></div>
