                    ...
                    <CardBody className="TableBody">
                        <CardTitle className="Title">Emergency alerts by date. </CardTitle>
                            ...
                            {this.props.barChartData.length ? 
                                ...
                                <BarChart width={700} height={250} data={this.props.barChartData} margin={{top: 10, right: 30, left: -35, bottom: 30}} >
                    ...
                    <CardBody className="TableBody">
                        <CardTitle className="Title">Trends in Parkinson's symptoms last five episodes. </CardTitle>
                            ...
                            {this.props.lineChartData.length ? 
                                ...
                                <BarChart width={1050} height={400} data={this.props.lineChartData} margin={{top: 10, right: 30, left: -22, bottom: 60}} >
                                ...
                                <div style={{width: 700, height: 350, paddingLeft: 7, width: 250}}>
                                    <br />
                ...
                <Card className="TableCard" style={{display: this.state.alertChart &&  this.props.chartToShow === "multiple episodes chart"  ? "block" : "none"}}>
                    <CardBody className="TableBody">
                        ...
                        {this.props.barChartData.length ? 
                            ...
                            <BarChart width={1050} height={400} data={this.props.barChartData} margin={{top: 10, right: 30, left: -22, bottom: 60}} >
