        ...
        return (
            ...
            <div> 
                <Card className="TableCard">
                    <CardBody>
                        <CardTitle className="TableTitle" style={{display: this.state.symptomChart ? "block" : "none"}}>Parkinson's symptoms by time of day/medication time </CardTitle>
                        <CardTitle className="TableTitle" style={{display: this.state.sideEffectChart ? "block" : "none"}}>Side Effects experienced by time of day/medication time </CardTitle>
                        <CardTitle className="TableTitle" style={{display: this.state.alertChart ? "block" : "none"}}>Emergency alerts by date </CardTitle>
                        ...
                        <div>
                            ...
                            <Row>
                                <Col md="12">
                                    ...
                                    <Button color="info" size="sm" style={{border: this.state.symptomChart ? '3px solid black': 'none', marginLeft: 0}} onClick = {() => this.onClickedSymptoms()}>Symptoms</Button>
                                    <Button color="info" size="sm" style={{border: this.state.sideEffectChart ? '3px solid black': 'none', marginLeft: 6}} onClick = {() => this.onClickedSideEffects()}>Side Effects</Button>
                                    <Button color="info" size="sm" style={{border: this.state.alertChart ? '3px solid black': 'none', marginLeft: 6}} onClick = {() => this.onClickedAlerts()}>Alerts</Button>
                                    
                                    <div style={{float: "right"}}>

                                        <span style={{display: !this.state.alertChart ? "inline" : "none", fontWeight: "bold", marginLeft: 25}}>Toggle: </span>
                            ...
                            <Row>
                                ...
                                <Col md="6" style={{marginLeft: -10, padding: 0}}>
                                    ...
                                    <LineChart style={{display: this.state.symptomChart ? "block" : "none"}} width={650} height={300} data={this.props.lineChartDataB} margin={{top: 10, right: 0, left: 0, bottom: 0}} >
                                        ...
                                        <Legend align="right" verticalAlign="top" layout="vertical" wrapperStyle={{ height: 262, padding: 10, fontWeight: 600, top: 8, right: -25, border: '1px solid grey', borderRadius: 3}} /> 
                                    </LineChart>

                                    <LineChart style={{display: this.state.sideEffectChart ? "block" : "none"}} width={650} height={300} data={this.props.lineChartDataB} margin={{top: 10, right: 0, left: 0, bottom: 0}} >
                                        ...
                                        <XAxis dataKey="name" tick={{fontWeight: "bold"}} padding={{left: 30, right: 30}}/>
                                        <Tooltip cursor={{strokeWidth: 20, opacity: 0.3}} position={{y: 10 }} content={<CustomTooltip data={this.props.medsToolTipsB} header="Time: "/>}/>
                                        <Legend align="right" verticalAlign="top" layout="vertical" wrapperStyle={{padding: 10, fontWeight: 600, top: 8, right: -25, border: '1px solid grey', borderRadius: 3}} />
                                    </LineChart>

                                    <BarChart style={{display: this.state.alertChart ? "block" : "none"}} width={680} height={250} data={this.props.barChartDataB} margin={{top: 10, right: 0, left: -10, bottom: 30}} >
                                        ...
                                        <Legend align="right" verticalAlign="top" layout="vertical" wrapperStyle={{ padding: 10, fontWeight: 600, top: 8, right: -10, border: '1px solid grey', borderRadius: 3}} />
                                        <br />
                                    </BarChart>  
                                    ...
                                    <div style={{marginLeft: 60, width: 465, marginTop: 10, marginBottom: 10}}>
                                            {this.props.episodeCount < 2 ?
                                                <p style={{paddingLeft: 20, lineHeight: 2.5, fontSize: 16, fontWeight: "bold", backgroundColor: "#9eb1bd"}}>Previous Episode
                                                    <span style={{fontSize: 16, fontWeight: "bold"}}>&nbsp;  ({moment(this.props.episodeDatesB[0]).format("ll")} - {moment(this.props.episodeDatesB[1]).format("ll")})</span>
                                                </p>
                                            : null }
                                    ...
                                    <div className="clearfix" style={{width: 675}}>

                                        <div style={{paddingLeft: 60, width: 525, float: "left"}}>
                                            <Medication
                                        ...
                                        <div style={{width: 125, padding: 10, borderStyle: "solid", borderWidth: 1, borderColor: "#666666", borderRadius: 3, float: "right"}}>
                                            <div style={{ fontWeight: 600, fontSize: 15, backgroundColor: "rgb(92, 178, 92, 0.2)",  marginBottom: 10}}>New</div>
                                            <div style={{ fontWeight: 600, fontSize: 15, textDecoration: "underline", backgroundColor: "rgb(252, 203, 0, 0.2)", marginBottom: 10 }}>Changed</div>
                                            <div style={{ fontWeight: 600, fontSize: 15, backgroundColor: "rgb(178, 92, 92, 0.2)", marginBottom: 10}}>Deleted</div>
                                        </div>
                                    </div> 
                                ...
                                <Col md="6" style={{paddingLeft: 60}}>
                                    ...
                                    <div style={{display: this.state.value === this.props.rangeMax ? "none" : "block"}}>
                                        <LineChart style={{display: this.state.symptomChart ? "block" : "none"}} width={500} height={300} data={this.props.lineChartDataA} margin={{top: 10, right: 0, left: 0, bottom: 0}} >
                                            <Line type='monotone' dataKey='Kickin' strokeDasharray="6 6" stroke="green"  fill="green" strokeWidth={1.5} style={{display: this.state.green ? "block" : "none" }}>
                                                <ErrorBar dataKey="KickinSD" width={4} strokeWidth={1.0} style={{display: this.state.green && this.state.errorOn ? "block" : "none" }}/> 
                                            </Line> 
                                            <Line type='monotone' dataKey='Wearoff' strokeDasharray="6 6" stroke="magenta" fill="magenta" strokeWidth={1.5} style={{display: this.state.magenta ? "block" : "none" }}>
                                        ...
                                        <LineChart style={{display: this.state.sideEffectChart ? "block" : "none"}} width={500} height={300} data={this.props.lineChartDataA} margin={{top: 10, right: 0, left: 0, bottom: 0}} >
                                            <Line type='monotone' dataKey='Sickness' strokeDasharray="3 4 5 2" stroke="green" fill="green" style={{display: this.state.green ? "block" : "none" }}>
                                                <ErrorBar dataKey="SicknessSD" width={4} strokeWidth={1.0} style={{display: this.state.green && this.state.errorOn ? "block" : "none" }}/> 
                                            </Line>
                                            <Line type='monotone' dataKey='Dizziness' strokeDasharray="3 4 5 2" stroke="magenta" fill="magenta" style={{display: this.state.magenta ? "block" : "none" }}>
                                        ...
                                        <BarChart style={{display: this.state.alertChart ? "block" : "none"}} width={500} height={250} data={this.props.barChartDataA} margin={{top: 10, right: 0, left: 0, bottom: 30}} >
                                            <Bar dataKey='Falls' stackId="a" fill="green" />
                                            <Bar dataKey='Freezing' stackId="a" fill="magenta" />
                                            <Bar dataKey='Choking' stackId="a" fill="orange" />
                                            <Bar dataKey='Hallucinations' stackId="a" fill="red" />
                                        ...
                                        <div style={{paddingLeft: 60, width: 500, marginTop: 10, marginBottom: 10}}>
                                            {this.props.episodeCount < 2 ?
                                                <p style={{paddingLeft: 20, lineHeight: 2.5, fontSize: 16, fontWeight: "bold", backgroundColor: "#9eb1bd"}}>Current Episode 
                                                    <span style={{fontSize: 16, fontWeight: "bold"}}>&nbsp;  ({moment(this.props.episodeDatesA[0]).format("ll")} - {moment(this.props.episodeDatesA[1]).format("ll")})</span>
                                                </p>
                                            : null }
                                        ...
                                        <div style={{width: 500, paddingLeft: 60}}>
                                            <Medication 
