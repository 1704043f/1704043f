...
export default class updateEnrollStatusCard extends React.Component {
    ...
    render () {
        return (
            ...
            <Card className="TableCard" style={{display: this.props.updateEnrollStatusCard ? "block" : "none"}}>
                <CardBody>
                    ...
                    {this.props.active ? 
                        ...
                        <Button color='danger' className="admin-btn right-align" onClick={() => this.onClickedUpdateStatus(this.props.pt_id, false)}>Make inactive</Button>
                        <Button className="admin-btn right-align" onClick={() => this.onClickedCancel(this.props.pt_id)}>No change</Button>
                    ...
                    <container>
                        ...
                        <Button color='success' className="admin-btn right-align" onClick={() => this.onClickedUpdateStatus(this.props.pt_id, true)}>Make active</Button> 
                        <Button className="admin-btn right-align" onClick={() => this.onClickedCancel(this.props.pt_id)}>No change</Button> 
