...
const AboutUs = ({ children }) => (
    <Container fluid id='aboutUs' className='home-section text-center '>
        <Row className='mh'>
            <Col>
                <div fluid className='text-center'>
                    <div fluid  className="dev-container">
                        <Row>
                            <Col md='4' className='aboutUsBG'><h1>About Us</h1></Col>
                            <Col md='4' className='text-center portrait-card'>
